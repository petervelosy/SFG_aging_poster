...
\textbf{Stimulus calibration}: Using an adaptive staircase method, the number of consistently rising parallel tones (\textquote{figure coherence}) was set individually for each participant such that they performed the figure detection task at 80\% accuracy (\textquote{high-SNR} condition). Next the number of background
tones (\textquote{noise}) was increased with a second staircase procedure, until
performance dropped to 60\% (\textquote{low-SNR} condition).
...
\section*{Behavioral results}
 ...
 \section*{EEG results}
	 ...
	 \textbf{The ORN amplitude showed an effect of SNR but no effect of age or hearing impairment.} The main effect of SNR was significant due to a higher ORN for high- than low-SNR trials.
	
	 \textbf{The P600 amplitude showed an effect of age but no effect of SNR or hearing impairment.} The P600 response showed higher amplitude in young subjects than in elderly subjects with or without hearing impairment. The two elderly groups did not significantly differ from each other.
